...
//using ResumeJobAnalysisTool.SK.Agents;
...
namespace ResumeJobAnalysisTool.Controllers;
...
public class ChatController : ControllerBase
{
    ...
    public async Task Get()
    {
        ...
        if (HttpContext.WebSockets.IsWebSocketRequest)
        {
            ...
            await Echo(webSocket, null, _chatCompletionService, _kernel, _configValues, _promptManager);
        }
        else
        {
