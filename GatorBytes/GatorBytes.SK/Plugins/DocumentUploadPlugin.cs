...
namespace GatorBytes.SK.Plugins
{
    public class DocumentUploadPlugin
    {
        private GatorBytesDBContext _context;
        private ConfigurationValues _configValues;

        public DocumentUploadPlugin(GatorBytesDBContext context, ConfigurationValues configValues)
        {
            _context = context;
