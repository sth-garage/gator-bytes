...
GO
/****** Object:  Table [dbo].[AgentPersonas]    Script Date: 12/2/2025 10:55:06 AM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[AnalysisAgentResults]    Script Date: 12/2/2025 10:55:06 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DocumentUploads]    Script Date: 12/2/2025 10:55:06 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[JobPostings]    Script Date: 12/2/2025 10:55:06 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[JobSkills]    Script Date: 12/2/2025 10:55:06 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MatchAnalysisResults]    Script Date: 12/2/2025 10:55:06 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MatchChatAnalysisResults]    Script Date: 12/2/2025 10:55:06 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[MatchChatAnalysisResults](
	...
	[ResumeId] [int] NOT NULL,
	[IsActive] [bit] NOT NULL,
 CONSTRAINT [PK_MatchChatAnalysisResults] PRIMARY KEY CLUSTERED 
(
	[Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO
/****** Object:  Table [dbo].[Prompts]    Script Date: 12/2/2025 10:55:06 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PromptTypes]    Script Date: 12/2/2025 10:55:06 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Resumes]    Script Date: 12/2/2025 10:55:06 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ResumeSkills]    Script Date: 12/2/2025 10:55:06 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[ResumeSkills](
	...
	[Justification] [varchar](max) NULL,
	[IsActive] [bit] NOT NULL,
	[LastUsed] [decimal](3, 2) NULL,
	[UsedWith] [varchar](max) NULL,
...
GO
/****** Object:  Table [dbo].[Skills]    Script Date: 12/2/2025 10:55:06 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
