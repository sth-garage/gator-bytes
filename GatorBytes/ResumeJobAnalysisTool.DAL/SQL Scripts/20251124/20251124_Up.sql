...
GO
/****** Object:  Table [dbo].[AgentPersonas]    Script Date: 11/24/2025 5:58:25 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[AnalysisAgentResults]    Script Date: 11/24/2025 5:58:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[AnalysisAgentResults](
	...
	[MatchPercentageAdjustment] [decimal](5, 2) NULL,
	[IsActive] [bit] NULL,
	[MatchChatAnalysisResultId] [int] NOT NULL,
...
GO
/****** Object:  Table [dbo].[DocumentUploads]    Script Date: 11/24/2025 5:58:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[JobPostings]    Script Date: 11/24/2025 5:58:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[JobRequirements]    Script Date: 11/24/2025 5:58:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MatchChatAnalysisResults]    Script Date: 11/24/2025 5:58:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Prompts]    Script Date: 11/24/2025 5:58:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PromptTypes]    Script Date: 11/24/2025 5:58:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Requirements]    Script Date: 11/24/2025 5:58:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Resumes]    Script Date: 11/24/2025 5:58:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ResumeSkills]    Script Date: 11/24/2025 5:58:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Skills]    Script Date: 11/24/2025 5:58:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
ALTER TABLE [dbo].[AnalysisAgentResults] ADD  CONSTRAINT [DF_AnalysisAgentResults_IsActive]  DEFAULT ((1)) FOR [IsActive]
GO
...
GO
ALTER TABLE [dbo].[JobRequirements] ADD  CONSTRAINT [DF_JobRequirements_IsActive]  DEFAULT ((1)) FOR [IsActive]
GO
ALTER TABLE [dbo].[MatchChatAnalysisResults] ADD  CONSTRAINT [DF_MatchChatAnalysisResults_IsActive]  DEFAULT ((1)) FOR [IsActive]
GO
...
GO
ALTER TABLE [dbo].[Requirements] ADD  CONSTRAINT [DF_Requirements_IsActive]  DEFAULT ((1)) FOR [IsActive]
GO
...
GO
ALTER TABLE [dbo].[AnalysisAgentResults]  WITH CHECK ADD  CONSTRAINT [FK_AnalysisAgentResults_MatchChatAnalysisResults] FOREIGN KEY([MatchChatAnalysisResultId])
REFERENCES [dbo].[MatchChatAnalysisResults] ([Id])
GO
ALTER TABLE [dbo].[AnalysisAgentResults] CHECK CONSTRAINT [FK_AnalysisAgentResults_MatchChatAnalysisResults]
GO
